...
class OSS {
    ...
    {
        $this->AccessKeyId = config('admin.aliyun_oss.AccessKeyId');
        $this->AccessKeySecret = config('admin.aliyun_oss.AccessKeySecret');
        $this->city = config('admin.aliyun_oss.city');
